package cleanmaster.yzy.supercleanmaster.ui;
...
import cleanmaster.john.waveview.WaveView;
import cleanmaster.library.enums.QuickReturnType;
import cleanmaster.library.listeners.QuickReturnListViewOnScrollListener;
import cleanmaster.yzy.supercleanmaster.adapter.ClearMemoryAdapter;
import cleanmaster.yzy.supercleanmaster.base.BaseSwipeBackActivity;
import cleanmaster.yzy.supercleanmaster.bean.AppProcessInfo;
import cleanmaster.yzy.supercleanmaster.model.StorageSize;
import cleanmaster.yzy.supercleanmaster.service.CoreService;
import cleanmaster.yzy.supercleanmaster.utils.StorageUtil;
import cleanmaster.yzy.supercleanmaster.utils.SystemBarTintManager;
import cleanmaster.yzy.supercleanmaster.utils.T;
import cleanmaster.yzy.supercleanmaster.utils.UIElementsHelper;
import cleanmaster.yzy.supercleanmaster.widget.textcounter.CounterView;
import cleanmaster.yzy.supercleanmaster.widget.textcounter.formatters.DecimalFormatter;
...
//        mListView.setAdapter(swingBottomInAnimationAdapter);
    ...
    public void onClickClear() {
        ...
        String cleared2 = getResources().getString(R.string.cleared2);
        String total = getResources().getString(R.string.total);
        T.showLong(mContext, total+" "+ StorageUtil.convertStorage(killAppmemory) + " "+cleared2);
        header.setVisibility(View.GONE);
        if (Allmemory > 0) {
            refeshTextCounter();
        }
